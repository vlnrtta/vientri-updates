...
class NuevoIngreso extends StatefulWidget {
  Entidad entidad;
  NuevoIngreso({super.key, required this.entidad});
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            ActionSheetOptions.show(
                              ...
                              onOptionSelected: (s) {
                                setState(() {
                                  _selectedOrigen = capitalize(s.nombre);
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(
                                  child: Text(
                                    _selectedOrigen == "" ? "Eige una ubicación" : capitalize(_selectedOrigen!),
                                    style: TextStyle(
                                      color: AppColors.semantics.text.body,
                                      fontSize: Fontsize.body,
                                    ),
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            ActionSheetOptions.show(
                              ...
                              onOptionSelected: (s) {
                                setState(() {
                                  _selectedEmpleado = capitalize(s.nombre);
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(
                                  child: Text(
                                    _selectedEmpleado == "" ? "Eige un empleado" : capitalize(_selectedEmpleado!),
                                    style: TextStyle(
